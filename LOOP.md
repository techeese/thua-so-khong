...
## Compass pointer
- next cycle: light self-review cycle (no subagents unless warranted): fresh full playthrough on live, phone-emulated screenshots via CDP if available (plain headless clamps at 500px — noted v0.24), small fixes; then next review round rotates to: performance re-audit after 10 versions of additions · a returning-player 3-run arc · VI copy pass on v0.16-v0.24 strings. OWNER DIRECTIVES standing: less narration · simple opening · buildings mean something. *(…v0.22 OWNER purposeful-movement · v0.23 constraint-seals · v0.24 arrival-moment+vow-grief+120Hz-time done)*
